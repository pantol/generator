...
def main():
    ...
    print("podany prefix bedzie ustawiony dla wszystkich faktur w pliku")
    ...
    while count < limit_2:
        ...
        for column in range((len(column_headers))):
            if column == 0:
                ...
                value = prefix_inv + str(generate_random_invoice_number(limit_inv_1, limit_inv_2)) # generacje nr faktureee
            elif column == 2:
